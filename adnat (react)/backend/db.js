...
run(
  "CREATE TABLE IF NOT EXISTS shifts (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER NOT NULL, start DATETIME NOT NULL, finish DATETIME NOT NULL, break_length REAL)"
);
run(
